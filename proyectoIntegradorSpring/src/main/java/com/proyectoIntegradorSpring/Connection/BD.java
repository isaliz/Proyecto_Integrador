package com.proyectoIntegradorSpring.Connection;
...
public class BD {
    ...
    private static final String SQL_CREATE2="DROP TABLE IF EXISTS ODONTOLOGOS; CREATE TABLE ODONTOLOGOS (ID INT AUTO_INCREMENT PRIMARY KEY, MATRICULA VARCHAR(100) NOT NULL, NOMBRE VARCHAR(100) NOT NULL, APELLIDO VARCHAR(100) NOT NULL)";
    private static final String SQL_PRUEBA2="INSERT INTO ODONTOLOGOS (MATRICULA, NOMBRE, APELLIDO) VALUES('MP10','Carlos ','Montaner'),('MP11','Joaquin','Luche')";
    ...
    public static  Connection getConnection() throws Exception{
        ...
        return DriverManager.getConnection("jdbc:h2:tcp://localhost/~/consultorio", "sa", "sa");
    }
}
